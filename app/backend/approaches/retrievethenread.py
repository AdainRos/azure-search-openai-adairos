...
info3.pdf: Open Source Security Contributions. I actively contributed to open-source projects in GitHub, focused on security and automation. I enhanced existing code and created new ones.
...
"""
    answer = "I've contributed to security through building robust cloud environments[info1.txt] and access control with detail documentation[info2.pdf][info4.pdf]."
